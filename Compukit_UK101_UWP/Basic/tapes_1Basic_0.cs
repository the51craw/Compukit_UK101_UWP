namespace Compukit_UK101_UWP
{
	public partial class BasicProg
	{
		public string[] RobotChase = new string[] {
			...
			" 10 FOR I=1TO 17:PRINT:NEXT",
			" 30 PRINT\"     ROBOT CHASE!!!\"",
			" 40 PRINT\"     --------------\"",
			" 50 PRINT:DIM R(6,2):SC=53196",
			" 55 PRINT:INPUT\"INSTRUCTIONS\";Q$:IFLEFT$(Q$,1)=\"N\"THEN 200",
			" 56 IF LEFT$(Q$,1)=\"Y\"THEN60",
			" 57 PRINT\"ANSWER Y OR N\":GOTO 55",
			...
			" 800 GOTO 870",
			" 810 IF PX<1 OR PX>48 OR PY<1 OR PY>15 THEN 860",
			" 850 GOTO 890",
			...
			" 1180 GOTO 600",
			" 2000 FORI=1TO32:PRINT:NEXT:RETURN",
            "RUN",
            " ",
		};
	}
